...
- Did you use the grouping selector for styles that both elements share? checked
- Did you make separate rules for the styles unique to each element? checked
