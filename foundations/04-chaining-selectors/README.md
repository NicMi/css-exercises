...
### Self Check
- Did you properly chain class selectors for each rule? checked
- Does the `proportioned` image retain its original square proportions? checked
- Does the `distorted` image end up looking squished and, well, distorted? checked
